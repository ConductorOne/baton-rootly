...
func New(ctx context.Context, baseURL, apiKey string) (*Connector, error) {
	rootlyClient, err := client.NewClient(ctx, baseURL, apiKey, client.ResourcesPageSize)
	if err != nil {
		return nil, err
	}
	return &Connector{
